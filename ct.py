...
class Analyzer(CtListener):
    ...
    def enterLib_def(self, ctx:CtParser.Lib_defContext):
        print(" [ lib_def, \'"+ctx.ID().getText()+"\', ",end="")
    ...
    def enterFn_def(self, ctx:CtParser.Fn_defContext):
        print(" [ fn_def, \'"+ctx.ID().getText()+"\', " ,end="")
    ...
    def enterGlob_var_def(self, ctx:CtParser.Glob_var_defContext):
        print(" [ glob_var_def, \'"+ctx.ID().getText()+"\', " ,end="")
    ...
    def enterPosition_initer(self, ctx:CtParser.Position_initerContext):
        print(" [ position_initer, " ,end="")
        if ctx.arrow() == None:
        	print(" [ arrow, \'LEFT_MOVE\', []], " ,end="")
